 ...
 *	참고) AI/빅데이터 처리 : 1)수집 2)데이터가공 3)적재(DB, 파일 등)
 */
@Log4j2
@Component
public class PublicApiJob {
//	상수 정의
	final String serviceKey = "aQbZo3Bi8Q1wPavwcIvlM9TvB5hnThhcOYVL%2BwoBVdLNKUXEzqPW1ARGRHpa3FF7SnSMeK9LulChdE7cTmJKDg%3D%3D";		// 공공데이터 API 인증키
...
//	10초마다 스캐줄 돌아감
//	사용법 : 크론식(cron = "*/초 분 시 일 월 요일 년(생략)")
//	* = 매 실행, */10 : 10초마다,10분마다... 등
	@Scheduled(cron = "*/10 * * * * ?")
