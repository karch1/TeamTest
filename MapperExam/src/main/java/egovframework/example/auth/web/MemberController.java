...
//	로그인 처리 : 보안 목적(@PostMapping사용)
//	@GetMapping: 1) 조회(로그인도) => id,암호(주소창에 표시)
//	@PostMapping : 2) 입력/수정/삭제 => id,암호가 (주소창에 표시안됨)
...
//		2) 세션을 만듬 : 유저저장(세션: 정보를 임시로 저장하는 공간 : 서버컴퓨터(스프링)에 저장)
//		사용법 : 세션.setAttribute("키", 값);
		session.setAttribute("memberVO", memberVO);
//		 (DB(영구적) vs 세션(임시:컴퓨터 재시작 사라짐),웹 브라우저를 꺼도 사라짐)
//		2-2) TODO: 보안코딩 : CSRF(사이트 위조) 공격 방어 : 인증 토큰
